...
class SponsorTemplateController extends Controller
{
    ...
    {
        return view('admin.templates.sponsors.index');
    }
    ...
    {
        return view('admin.templates.sponsors.create', [
    ...
    public function store(TemplateRequest $request)
    {
        try {
            ...
            $template_view = 'templates/sponsors/' . Str::random(15);

            //    creating new template
            $template = Template::create([
                'type' => TemplateType::SPONSOR->value,
                'title' => $request->title,
                'active' => true,
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.templates.sponsors.edit', [
            'template' => $template,
            'adlee_logo' => '{{ $adlee_logo }}',
            'person_title' => '{{ $person_title }}',
            'person_name' => '{{ $person_name }}',
