<x-layouts.app-layout title="Booklet Shipments" is-sidebar-open="true">
    <div
        ...
        <a href="{{ route('sponsors.active-jobs', $booklet) }}"
                                        ...
                                        <td class="whitespace-nowrap border border-slate-200 px-3 py-3 dark:border-navy-500 lg:px-5"
                                            ...
                                            <div class="flex items-center gap-2 flex-wrap justify-center">
                                                ...
                                                <a href="{{ $job->shipment->download_zpl }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                                        height="14" fill="currentColor" class="bi bi-cloud-download"
                                                        viewBox="0 0 16 16">
                                                        <path
