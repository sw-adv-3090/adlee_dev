<div class="main-sidebar">
    <div
        ...
        <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
            <!-- Dashobards -->
            <a href="{{ route(route_name() . '.dashboard') }}"
            ...
            @admin()
                <x-app-partials.admin-sidebar />
            @endadmin

            @sponsor
                <x-app-partials.sponsor-sidebar />
            @endsponsor

            @bbo
                <x-app-partials.ad-space-owner-sidebar />
            @endbbo
                        ...
                        <div class="flex flex-col pt-2 pb-5">
                            ...
                            <a href="{{ route('browser_sessions') }}"
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-slate-400 line-clamp-1 dark:text-navy-300">
                                        {{ __('Your all logged in sessions') }}
                                    </div>
                                </div>
                            </a>
                            {{-- <a href="#"
