<x-layouts.app-layout title="Create Sponsor Template" is-sidebar-open="true">
    <div
            ...
            <div class="card">
                <div class="tabs flex flex-col">
                    <div class="tab-content p-4 sm:p-5">
                        <form action="{{ route('admin.templates.sponsors.store') }}" method="post"
                            ...
                            <div class="space-y-5">
                                ...
                                {{-- <label class="block">
                                    <span class="font-medium text-slate-600 dark:text-navy-100">Styling</span>
                                    <p class="mt-1.5 text-sm">
                                        <textarea rows="10" name="styling"
                                            placeholder=" Enter styling of template with starting of style tag i.e <style> and end your styling with eding style tag i.e </style>."
                                            class="form-textarea mt-2 w-full resize-none rounded-lg border border-slate-300 bg-transparent p-2.5 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"></textarea>
                                </label> --}}

                                {{-- <label class="block">
                                    <span class="font-medium text-slate-600 dark:text-navy-100">HTML Condent</span>
                                    <textarea rows="10" name="styling" placeholder=" Enter HTML condent of template"
                                ...
                                <label class="block">
                                    <span class="font-medium text-slate-600 dark:text-navy-100">File</span>
                                    <input
                                        class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                        type="file" name="file" />
                                </label>
