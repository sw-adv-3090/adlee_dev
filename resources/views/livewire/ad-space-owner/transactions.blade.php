                        ...
                        <tr class="border-y border-transparent">
                            ...
                            <td class="whitespace-nowrap flex items-center gap-2 px-4 py-3 sm:px-5">
                                <div class="avatar flex">
                                    <img class="rounded-full" src="{{ asset($payment->sender?->avatar) }}"
                                        alt="ٰImage" />
                                </div>
                                <div class="flex flex-col">
                                    <span class="text-sm">{{ $payment->sender?->name }}</span>
                                    <span>{{ $payment->sender?->email }}</span>
                                </div>
                            </td>
                            <td
                            ...
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                <a href="{{ route('ad-space-owner.transactions.invoice', $payment) }}"
