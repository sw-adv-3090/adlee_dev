<x-layouts.app-layout title="Coupon Templates" is-sidebar-open="true">
    <div
        ...
        <div>
            ...
            <p class="mt-1 hidden sm:block">List of all coupons templates</p>
        </div>
        <a href="{{ route('admin.templates.coupons.create') }}"
    ...
    <div class="mt-4 sm:mt-5 lg:mt-6">
        ...
        @livewire('admin.templates.coupons')
    </div>
