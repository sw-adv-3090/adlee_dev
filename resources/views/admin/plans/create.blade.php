<x-layouts.app-layout title="Create Plan" is-sidebar-open="true">
    <div
                ...
                <div class="tabs flex flex-col">
                    <div class="tab-content p-4 sm:p-5">
                        <form action="{{ route('admin.plans.store') }}" method="post">
                            ...
                            <div class="space-y-5" x-data="{ show: '{{ old('type') === 'sponsor' ? true : false }}' }">
                                {{-- plan type --}}
                                <label class="block">
                                ...
                                <div x-show="show">
                                    ...
                                    <label class="mt-1.5 flex -space-x-px">
                                        ...
                                        <input
                                            ...
                                            name="ach_transaction_fee" value="{{ old('ach_transaction_fee') }}" />
                                    </label>
                                ...
                                <div x-show="show">
                                    ...
                                    <label class="mt-1.5 flex -space-x-px">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('credit_card_transaction_fee') }}" />
                                    </label>
                                ...
                                <div x-show="show">
                                    ...
                                    <label class="mt-1.5 flex -space-x-px">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('transaction_service_fee') }}" />
                                    </label>
                                ...
                                <label class="block" x-show="show">
                                    ...
                                    <input
                                        ...
                                        type="number" name="template_limit" value="{{ old('template_limit') }}" />
                                </label>
                                ...
                                <label class="block" x-show="show">
                                    ...
                                    <input
                                        class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent "
                                        placeholder="Enter free booklets offer in plan, please write 0 if offer no booklet"
                                        type="number" name="free_booklets" value="{{ old('free_booklets') }}" />
                                </label>
                                @error('free_booklets')
                                    <span class="text-xs text-error">{{ $message }}</span>
                                @enderror
                                    ...
                                    <div>
                                        <label class="block">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('booklet_pages') }}" step="50" />
                                        </label>
                                        @error('booklet_pages')
                                            <span class="text-xs text-error">{{ $message }}</span>
                                        @enderror
