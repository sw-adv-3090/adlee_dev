...
<head>
    ...
    {{-- <link href="{{ asset('build/assets/app-CbL8PpA4.css') }}" rel="stylesheet">
    <link href="{{ asset('build/assets/app-DdUA2WZk.css') }}" rel="stylesheet">
    <script src="{{ asset('build/assets/app-DoYzbnk5.js') }}"></script> --}}
