<x-layouts.app-layout title="Create Template Category" is-sidebar-open="true">
    <div
    ...
    <div class="min-w-full mt-8">
        <div class="card">
            <div class="p-4 sm:p-5">
                <form action="{{ route('admin.templates.categories.store') }}" method="post">
                    @csrf
                    <div class="space-y-5">
                        <label class="block">
                        ...
                        @livewire('upsert-sub-categories')
