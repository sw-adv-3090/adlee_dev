<div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6 mt-8">
    ...
    <div class="col-span-12 grid lg:col-span-9">
        <div class="card p-4 sm:p-5">
            <div wire:loading wire:loading wire:target="update">
                <div
            ...
            <form wire:submit="update">
                <div class="space-y-5">
                    @if ($step === 'info')
                        ...
                        <label class="block">
                            <span class="font-medium text-slate-600 dark:text-navy-100">Confirm Coupon Amount</span>
                            <input
                                class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent "
                                placeholder="Confirm coupon amount" type="text" wire:model="confirm_amount"
